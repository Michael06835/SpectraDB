...
RUN_DIR = ROOT / "runs" / "EXP-RAMAN-001-FULL"
...
def main():
    ...
    print()
    print("=" * 80)
    print("Raman threshold calibration")
    print("=" * 80)
    ...
    # num_workers=0 deliberately avoids the Windows page-file
    # issue encountered after the full Raman training run.
    ...
    summary = {
        ...
        "checkpoint":
            "runs/EXP-RAMAN-001-FULL/best_model.pt",
