...
def calculate_metrics(
    ...
    metrics["ap_per_label"] = (
        ap_per_label
    )

    metrics["auroc_per_label"] = (
        auroc_per_label
    )
...
def main():
    ...
    print(
        "EXP-RAMAN-002-FULL "
        "weighted checkpoint evaluation"
    )
    print("=" * 80)
    ...
    # ========================================================
    # Rebuild weighted BCE from training labels
    # ========================================================
    ...
    # Dataset / DataLoader
    #
    # num_workers=0 avoids Windows multiprocessing
    # page-file / MemoryError failures.
    # ========================================================
    ...
    print("=" * 80)
    print(
        "Weighted checkpoint evaluation completed"
    )
    print("=" * 80)
