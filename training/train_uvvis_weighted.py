...
RUN_DIR = ROOT / "runs" / "EXP-UVVIS-002-FULL"


# ============================================================
# EXP-UVVIS-002-FULL configuration
# ============================================================
...
# Uses sqrt(raw pos_weight) with cap=20 for comparability
# with the IR/Raman weighted-BCE experiments.
USE_POS_WEIGHT = True
...
def main():
    ...
    print()
    print("=" * 80)
    print("EXP-UVVIS-002-FULL")
    print("QM9S UV-Vis -> structural feature baseline")
    print("=" * 80)
    ...
    print()
    print("=" * 80)
    print("EXP-UVVIS-002-FULL completed")
    print("=" * 80)
