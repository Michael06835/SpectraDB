...
RUN_DIR = ROOT / "runs" / "EXP-UVVIS-001-SANITY"
...
print("=" * 70)
print("EXP-UVVIS-001-SANITY")
print("QM9S UV-Vis -> structural feature sanity check")
print("=" * 70)
...
print()
print("UV-Vis valid train samples:", len(train_indices))
...
# ============================================================
# Inspect input shape and sanity subset
# ============================================================
...
print(
    "Spectrum shape:",
    tuple(first_sample["spectrum"].shape),
)
