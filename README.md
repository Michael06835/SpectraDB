...
项目目标是建立统一的多模态光谱数据库，并实现从光谱推断分子结构信息：以单模态1D-CNN模型（IR、Raman、UV-Vis）为基础，进一步进行三模态特征融合，并逐步实现官能团/结构特征识别、完整分子结构候选推断、分子结构可视化及模型可解释性分析。
...
* GDB-9-Ex：补充UV-Vis数据（约9.7万分子，激发态能量与振子强度）
